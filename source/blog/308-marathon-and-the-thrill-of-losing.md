...
{% mention 'Christa' %}, a Bungie lover of the old school[^bungie] and
particular aficionada of the original *Marathon* trilogy, talked it up to me
...
scandal of the visual design[^plagiarism], she kept excitedly sending me updates
and videos. I read along interested enough, but it did little to make me want to
pick up the game myself.

[^bungie]: There is a particular class of people who react to the mention of
    Bungie as a company by getting a wistful look in their eyes and saying
    something like "oh... Bungie..." as though they had vanished like the *Mary
    Celeste* after releasing *Halo: Reach*.

[^plagiarism]: A brief recap for the uninitiated. *Marathon*'s visual design is
    ...
    feels futuristic while being in conversation with [real-world visual
    design][][^tdr]. It's a game that can be appreciated as visual art beyond
    the level of "wow pretty landscape", which is nearly unheard of in western
    AAA.

    It is also extremely similar to the work of the digital artist [Antireal],
    who as it turned out was followed on X by the *Marathon* design lead along
...
[^tdr]: The Designers Republic is its own story, a firm so colossally
    ...
    and interesting way "speaks to how well it is pulled off in *Marathon*".

I'm not much for shooters. That's not to say I haven't played or enjoyed them; I
played through a couple James Bond games[^bond] and the *Halo 2* campaign as a
child, I played *Splatoon*s 1 and 2 for a respectable number of hours, and I
even cleared the original *Destiny* single-player content while recovering from
...
all—*Doom*, *Quake*, *Half-Life*, *Call of Duty*, *Team Fortress*, *Fortnite*,
*Overwatch*, or indeed the original *Marathon* games.

[^bond]: Even then I entirely missed *Goldeneye 007*, to this day the definitive
    video game incarnation of the storied imperialist running dog.

When the open server slam came, I didn't play it, even as more friends beyond
...
*wasn't* shooting, the thought started wriggling its way into my brain.

"What if I *did* play *Marathon*?"

As I continued watching my friends, as Christa continued sending me videos of
feats of meticulous planning as well as derring-do, as I learned more about what
the structure of an "extraction shooter"[^extraction] meant in practice, this
thought grew. I found my [modding work] in a lull, waiting for upstream changes
and code reviews, with no particular video game on deck[^backlog]. I decided to
give it a try.

[^extraction]: For those unfamiliar with this relatively new genre, it functions
    similarly to a battle royale in that multiple players or teams are placed on
    a shared map where they can shoot one another[^pvp]. However, the goal isn't
...
[^tarkov]: The progenitor of the "extraction shooter", and another foundational
    shooter that I've never played nor had any real interest in.

[modding work]: https://nex-3.com/blog/becoming-a-video-game-scientist-part-1/

[^backlog]: This is, I admit, not entirely true. I still haven't played the most
    recent two chapters of *Deltarune*, and too many people have told me how
    excellent *Of the Devil* is for me to ignore it just because I find the art
    style unappealing. But sometimes one's fingers itch to play a game with a
    sense of motion[^menus].

[^menus]: Despite its motive fundamentals, though, *Marathon* is decidedly
    [menus] rather than parkour. This should come as no surprise given that
    Bungie's other active game[^d2] is explicitly called out as menus in the
    original comic.
...
[peak monthly player count]: https://steamcharts.com/app/1085660#All

[^sony]: subsidiary of Sony Interactive Entertainment LLC

What really started singing to my soul and got me to spend the $40 USD wasn't
even necessarily the prospect of hand-fun from playing the game, but rather
mind-fun[^funs] from engaging its design with a critical eye. Christa is fond of
...
relationship between mechanical design and player experience was [*Resident Evil
GCN*]. Everything in this game is part of the texture of interactivity in a way
...
over and the enemy has left, which means that mid-level[^levels] players can
...
[^funs]: Surely this is a distinction that needs no further explanation.

[*Resident Evil GCN*]: https://backloggd.com/u/nex3/review/194159/

[^levels]: Framing this in terms of "levels" is actually an oversimplification.
...
[^free kit]: An important part of *Marathon*'s ecosystem, which as I understand
    ...
    comfortably full of equipment the emotional comfort of risking nothing.

    Perhaps paradoxically, free kits go a long way to acclimating players who
    ...
    [way less important] than positioning and tactics. Free kits make it viable
    to hunt players even when you expect to lose the first four encounters. As
    I'll get to later in the post, loss has its virtues.

[^skins]: Successfully exfiltrating with a free kit also gives the player a
    cosmetic recolor of their current shell[^shell], leading to days when a
    ...
    kits as a low-pressure alternative to bringing in real gear.

[^shell]: class

[way less important]: https://www.reddit.com/r/Marathon/comments/1rvimao/things_i_learned_after_100_hours_in_marathon/

But I don't have room in this post[^footnotes] to go on at length about every
aspect of this game's design I find fascinating. I want to focus instead on one
particular aspect: the way the game handles loss.

[^footnotes]: Certainly not if I keep writing more footnotes than I write body
    text. Sometimes ideas are a straight line, and sometimes they're a tree.
    Today is a tree kind of day.

## The Sweat

I personally have never struggled much with the despair of losing my equipment
in this game. Maybe it was the fires of *Magic: the Gathering* that forged my
emotional fortitude, where the difference between a win and a loss was at the
mercy of the top card of my deck[^variance]. Maybe it was seeing other players
at those tournaments tilting to the point of public meltdown and resolving early
to learn to bend with the good and bad but never snap.

[^variance]: The tension of the draw step[^strategy] as driven by the land
    system is in fact the heart of why that game engine is as successful as it
    is and has as much depth as it does. Compare to the [Vs. System] where
    ...
    compare also to the [*World of Warcraft* TCG] where the variance was so
    concentrated in the opening die roll to determine who got the first turn
    that the winner of that roll was wildly favored to win the game. *Magic*
    sits at a comfortable point where the very best players have something like
    a 65% win rate against other pros; real, respectable, but not dominant.

[Vs. System]: https://en.wikipedia.org/wiki/Vs._System
[*World of Warcraft* TCG]: https://en.wikipedia.org/wiki/World_of_Warcraft_Trading_Card_Game

[^strategy]: It's also worth noting that the amount that a given card draw
    determines the course of the game is never quite so dramatic as it seems in
    the moment. Part of the genius of *Magic* is its
    [lenticularity][][^rosewater]: all the decisions you've made in the game up
...
[lenticularity]: https://magic.wizards.com/en/news/making-magic/lenticular-design-2014-12-15

[^rosewater]: When I was young, I was a huge reader of Mark Rosewater's blog.
    ...
    cheerleader for a company[^hasbro] subject to inevitable capitalist rot. I
...
[^hasbro]: subsidiary of Hasbro, Inc.

Bending with it is crucial, though: I gotta *feel* the emotions even though I
try not to let them overwhelm me. The point of a game, after all, is the
emotions[^people]. I don't just want to go through the motions when I play a
game, I want to care about the outcome. I want to feel *the sweat*.

[^people]: The point of a game is also engaging with people. In fact, the human
    connection is probably *more* important for me than any individual aspect of
    ...
    itself [catalyzed by human contact], all conscious articulated thought is
    intrinsically interpersonal.

    I don't consider this incompatible with the idea that the point of the game
    ...
    discussing that game with others.

[catalyzed by human contact]: https://en.wikipedia.org/wiki/Feral_child

The sweat is the sense of anxiety that comes from a combination of caring about
...
The possibility of failure is critical. Without it, there can be no sweat, no
tension. And without tension, there can be no release.

## Extraction Shooters and Roguelikes

In the first few days of *Marathon*'s release, when a few of my friends were
...
right? Perhaps not. More likely, you don't know which of the [constellation of
traits] that cluster around this genre-concept I might specifically be referring
to. Here, I mean it in the broad sense, what might be called a
"roguelite"[^roguelite] by some: a game organized into individual runs whose
progress is largely divorced from one another and lost forever if a run fails.

[constellation of traits]: https://azhdarchid.com/the-sao-paulo-interpretation-of-immersive-sims/

[^roguelite]: Personally I find the impulse to try to make genre names perfectly
    ...
    anything I'd expect to be accurately descriptive in itself.

Losing a run in a roguelike can be painful, but at the end of the day all you're
...
little bit more about the game and get a little better for an eventual victory.

The extraction shooter structure is very similar to a roguelike from a
sufficient level of abstraction[^formalism]. It's also organized into individual
...
[^formalism]: Boiling games down to basic relationships between coarse-grained
    ...
    across many games, genres are often[^horror] expressed in these heavily
    ...
    pitch" style of conjunctive description.

[^horror]: Even the "survival horror" genre, whose name is so focused on its
    ...
    and fear almost feels like a happy accident.

But there's a critical difference between the two structures. In a roguelike,
nothing carries over from one run to another. In an extraction shooter, that
carrying-over is the whole point[^point].

[^point]: There's an interesting question lying latent here: how much is our
    ...
    dungeon-delving RPG is the genre *du jour* and "leaving with more than you
    came with" is taken for granted as the point of a unit of play. How would we
    describe an extraction shooter in that world?

There are two ways to look at the difference between a run in a roguelike and an
...
will give you a leg up on your next few runs.

These perspectives are two sides of the same coin. The gear you take in only
...
A parallel difference exists between the soul mechanic pioneered in *Demon's
Souls* (made popular by *Dark Souls*) and the traditional way dungeon delvers
handle the loss of experience. In *Demon's Souls*, experience points are called
...
spend them at the next checkpoint[^bonfires].

[^bonfires]: You can think of this as motivating the player to beat their own
...
A common refrain among new players of these games is that losing their souls is
...
save, and *everything* you've done since then is erased.

We see here the same dichotomy that we did before between extraction shooters
...
what truly matters is the player's emotional experience.

## Losing Rules

A lesson that dedicated soulslike players learn fairly quickly is that this
...
through these games never leveling up at all[^sl1]!

[^sl1]: I've done this almost three times: once for *Elden Ring*, once for *Dark
    Souls*, and not quite to the end of *Sekiro*[^isshin]. The substantial
    majority of these runs weren't even very hard—these games are made to be
    beaten. The difficulty sliders that people howl for *do* exist, they're just
    ...
    particularly hard to optimize for power.

[^isshin]: *Sekiro* is an odd game because it doesn't have a single definition
    ...
    something I have not yet found the stamina to train myself to do.

When I play, though, I try not to let myself fall into thinking of souls as
unimportant, even though that's entirely accurate. I actively *try* to get back
...
It sounds obvious when I write out: games are more fun if you care about them. I
...
corner of the screen has value.

The brilliance of an extraction shooter, just like the brilliance of the soul
...
points you lost don't because the potential to get them back makes them *your
souls*, even if they're ultimately lost anyway. The gear you bring in an
extraction shooter is *your gear* because you chose to risk it, even if you
stole it off someone else's corpse in the first place. You have a stake in the
game, and that stake is the wellspring of the sweat.

None of this would be possible without loss. In fact, engineering situations
